...
class CoreDBHelper{
    ...
    func insertEntity(_ entity: Entity) {
        do{
            ...
            entityToBeInserted.name = entity.name
            entityToBeInserted.desc = entity.desc
            entityToBeInserted.email = entity.email
            entityToBeInserted.password = entity.password
            entityToBeInserted.type = entity.type
            entityToBeInserted.address = entity.address
            entityToBeInserted.deliveryPartnerInfo = entity.deliveryPartnerInfo
            entityToBeInserted.images = entity.images
            entityToBeInserted.foodItems = entity.foodItems
            entityToBeInserted.connectionRequests = nil
            entityToBeInserted.activeDonations = nil
            entityToBeInserted.pastDonations = nil
            entityToBeInserted.connections = nil
    ...
    func updateEntity(entityToUpdate: Entity, withEntity: Entity) {
        if let entityName = entityToUpdate.name,
            let fetched = self.searchEntityByName(entityName) {
            self.moc.delete(fetched)
            self.insertEntity(withEntity)
            print("Entity updated correctly")
            return
        }
        print("Entity not updated...")
    }
